        ...
        <Container>
          <Row noGutters className="mb-5  justify-content-center">
            <Col lg={11}>
              <Row
                noGutters
                className=" justify-content-center  fix-holder-height"
              >
                <Col lg={5} className=" ">
                ...
                <Col lg={7} className="text-left bg-warning  info-div">
                  ...
                  <div className="mb-5">
                    ...
                    <p>
                      I am a serial Entrepreneur that loves the thrill of the
                      hunt and close. I thrive under pressure helping businesses
                  ...
                  <div className="mb-5">
                    ...
                    <p>
                      I will be the first to say that most companies fail
                      because of the vision. The vision is small or they get
                      side tracked. Are you one of those people? Did you lose
                      site of your “Why”? Whether you need me or another coach,
                      the important part is just make sure you have one.
                    </p>
                  </div>
                  ...
                  <div className="mb-5">
                    ...
                    <p>
                      I will show you to succeed with any business. It’s about
                      you and your story. Let’s talk!
                    </p>
                  </div>
                </Col>
              </Row>
                ...
                <Col lg={7} className="text-left bg-warning  info-div">
                  ...
                  <div className="mb-5">
                    ...
                    <p>
                      ...
                      Nike? lol really it’s about just getting up and saying
                      “Yes I can”
                    </p>
                  </div>
                  ...
                  <div className="mb-5">
                    ...
                    <p>
                      We would like to lock arms with businesses that are tired
                      of being tired. Contact me today
                    </p>
                  </div>
                </Col>
              </Row>
